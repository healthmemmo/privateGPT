...
## [0.0.1](https://github.com/healthmemmo/privateGPT/compare/v0.2.0...v0.0.1) (2024-01-03)


### Features

* **API:** Ingest plain text ([#1417](https://github.com/healthmemmo/privateGPT/issues/1417)) ([6eeb95e](https://github.com/healthmemmo/privateGPT/commit/6eeb95ec7f17a618aaa47f5034ee5bccae02b667))
...
* **llm:** Add openailike llm mode ([#1447](https://github.com/healthmemmo/privateGPT/issues/1447)) ([2d27a9f](https://github.com/healthmemmo/privateGPT/commit/2d27a9f956d672cb1fe715cf0acdd35c37f378a5)), closes [#1424](https://github.com/healthmemmo/privateGPT/issues/1424)
* **llm:** drop default_system_prompt ([#1385](https://github.com/healthmemmo/privateGPT/issues/1385)) ([a3ed14c](https://github.com/healthmemmo/privateGPT/commit/a3ed14c58f77351dbd5f8f2d7868d1642a44f017))
...
* **settings:** Configurable context_window and tokenizer ([#1437](https://github.com/healthmemmo/privateGPT/issues/1437)) ([4780540](https://github.com/healthmemmo/privateGPT/commit/47805408703c23f0fd5cab52338142c1886b450b))
* **settings:** Update default model to TheBloke/Mistral-7B-Instruct-v0.2-GGUF ([#1415](https://github.com/healthmemmo/privateGPT/issues/1415)) ([8ec7cf4](https://github.com/healthmemmo/privateGPT/commit/8ec7cf49f40701a4f2156c48eb2fad9fe6220629))
...
* **ui:** Allows User to Set System Prompt via "Additional Options" in Chat Interface ([#1353](https://github.com/healthmemmo/privateGPT/issues/1353)) ([145f3ec](https://github.com/healthmemmo/privateGPT/commit/145f3ec9f41c4def5abf4065a06fb0786e2d992a))
* **ui:** make chat area stretch to fill the screen ([#1397](https://github.com/healthmemmo/privateGPT/issues/1397)) ([c71ae7c](https://github.com/healthmemmo/privateGPT/commit/c71ae7cee92463bbc5ea9c434eab9f99166e1363))
...
* **deploy:** fix local and external dockerfiles ([fde2b94](https://github.com/healthmemmo/privateGPT/commit/fde2b942bc03688701ed563be6d7d597c75e4e4e))
...
* **docker:** docker broken copy ([#1419](https://github.com/healthmemmo/privateGPT/issues/1419)) ([059f358](https://github.com/healthmemmo/privateGPT/commit/059f35840adbc3fb93d847d6decf6da32d08670c))
* **docs:** Update quickstart doc and set version in pyproject.toml to 0.2.0 ([0a89d76](https://github.com/healthmemmo/privateGPT/commit/0a89d76cc5ed4371ffe8068858f23dfbb5e8cc37))
...
* **settings:** correct yaml multiline string ([#1403](https://github.com/healthmemmo/privateGPT/issues/1403)) ([2564f8d](https://github.com/healthmemmo/privateGPT/commit/2564f8d2bb8c4332a6a0ab6d722a2ac15006b85f))
...
* Windows permission error on ingest service tmp files ([#1280](https://github.com/healthmemmo/privateGPT/issues/1280)) ([f1cbff0](https://github.com/healthmemmo/privateGPT/commit/f1cbff0fb7059432d9e71473cbdd039032dab60d))
